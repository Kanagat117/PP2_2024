...
def movies_by_category(movies_list, category_name):
...
def average_imdb_score(movies_list):
    ...
    return total_score / len(movies_list) if movies_list else 0

def category_average_imdb_score(movies_list, category_name):
    category_movies = movies_by_category(movies_list, category_name)
